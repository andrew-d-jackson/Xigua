...
namespace xig {
	...
	//! Error class that will be thrown as an exception if somethign goes wrong with Xigua
	class error {
	private:
	...
	public:
		//! Construct an error with a type, description to be printed to the end user, and the function call list
